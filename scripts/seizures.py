...
for headstage_letters in recordings_letters_1:
    ...
    for anim_id in recordings_1_channel[headstage_letters]:
        ...
        br_state_indices = preprocessing_steps.get_seizure_indices(br_state_file)
...
for headstage_letters in recordings_letters_2:
        ...
        for anim_id in recordings_2_channels[headstage_letters]:
            ...
            br_state_indices_1 = preprocessing_steps.get_seizure_indices(part_1_br_state)
            br_state_indices_2 = preprocessing_steps.get_seizure_indices(part_2_br_state)
            if len(br_state_indices_1) > 0:
                epoch_1 = preprocessing_steps.get_epoch_indices(br_state_indices_1)
                ...
                print('no epochs for ' + str(anim_id) + ' ' + str(brainstate))
            if len(br_state_indices_2) > 0:
                epoch_2 = preprocessing_steps.get_epoch_indices(br_state_indices_2)
